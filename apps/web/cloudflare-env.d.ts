/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: bb7d3e8bd84622728d28f3a8e16370eb)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		CMS_EMAIL: "josh@joshferrara.com";
		EMAIL_PROVIDER: "stub";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CMS_EMAIL" | "EMAIL_PROVIDER" | "SITE_URL" | "CONVEX_DEPLOYMENT" | "NEXT_PUBLIC_CONVEX_URL" | "NEXT_PUBLIC_CONVEX_SITE_URL">> {}
}
